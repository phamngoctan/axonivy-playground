[Ivy]
16D296FCCE091A02 3.23 #module
>Proto >Proto Collection #zClass
Rs0 RedirectDialogProcess Big #zClass
Rs0 RD #cInfo
Rs0 #process
...
>Proto Rs0 Rs0 RedirectDialogProcess #zField
Rs0 f0 guid 16D296FCD206C61B #txt
Rs0 f0 type demo.RedirectDialog.RedirectDialogData #txt
...
Rs0 f1 type demo.RedirectDialog.RedirectDialogData #txt
Rs0 f1 211 51 26 26 0 12 #rect
Rs0 f1 @|RichDialogProcessEndIcon #fIcon
Rs0 f2 expr out #txt
Rs0 f2 109 64 211 64 #arcP
Rs0 f3 guid 16D296FCD3C43205 #txt
Rs0 f3 type demo.RedirectDialog.RedirectDialogData #txt
Rs0 f3 actionDecl 'demo.RedirectDialog.RedirectDialogData out;
' #txt
...
Rs0 f4 type demo.RedirectDialog.RedirectDialogData #txt
Rs0 f4 guid 16D296FCD3C81EEA #txt
Rs0 f4 211 147 26 26 0 12 #rect
Rs0 f4 @|RichDialogEndIcon #fIcon
Rs0 f5 expr out #txt
Rs0 f5 109 160 211 160 #arcP
>Proto Rs0 .type demo.RedirectDialog.RedirectDialogData #txt
